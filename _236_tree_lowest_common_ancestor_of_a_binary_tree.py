...
class Solution2:
    ...
    def lowestCommonAncestor(self, root, p, q):
        ...
        stack = [(root, Solution2.BOTH_PENDING)]
        ...
        while stack:
            ...
            if parent_state != Solution2.BOTH_DONE:
                ...
                if child_node:
                    stack.append((child_node, Solution2.BOTH_PENDING))
            else:
...
if __name__ == '__main__':
    ...
    output_1 = demo.lowestCommonAncestor(root, root.left, root.left.right.right)
    output_2 = demo.lowestCommonAncestor2(root, root.left, root.left.right.right)
    output_3 = demo2.lowestCommonAncestor(root, root.left, root.left.right.right)
    print(output_1.val, output_2.val, output_3.val, end=' ')
